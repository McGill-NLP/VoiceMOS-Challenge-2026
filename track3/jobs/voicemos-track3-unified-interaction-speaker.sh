#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-unified-interaction-speaker
...
# Ablation of --interaction for SPEAKER similarity (spk_sim), 20,000 steps per arm.
#
#   sbatch track3/jobs/voicemos-track3-unified-interaction-speaker.sh
#
...
# both targets (SYS-SRCC 0.890 against 0.946 for `base`), and a frozen phase would delay
...
echo "  spk_sim  ladder base/ecapa @8k     uMSE 0.412  uLCC 0.538  uSRCC 0.501  sMSE 0.064  sLCC 0.934  sSRCC 0.946"
echo "  spk_sim  best uSRCC anywhere       CORAL eres2netv2-moe 0.562 @16000 (batched eval)"
echo ""
