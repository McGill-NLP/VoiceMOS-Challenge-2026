#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-unified-mse-accent
...
# Plain MSE + two-phase freeze, across encoder x head, for ACCENT similarity (acc_sim).
#
#   sbatch track3/jobs/voicemos-track3-unified-mse-accent.sh
#
# The MSE counterpart of voicemos-track3-unified-coral-accent.sh. Everything except
...
#       track3/jobs/voicemos-track3-unified-mse-accent.sh
...
#       track3/jobs/voicemos-track3-unified-mse-accent.sh
#
# Best acc_sim so far on this dev set, at the checkpoint each run selected (see
# ../../BRANCHES.md): base/ecapa uMSE 0.372, uSRCC 0.468, sSRCC 0.970;
# CORAL/commonaccent-moe uMSE 0.365, uSRCC 0.490, sSRCC 0.923. Selected instead on
# UTT-SRCC, CORAL/commonaccent-moe reached 0.502 at step 20000.
#
# commonaccent-ecapa has the strongest prior claim on this target specifically: a VoxCeleb
# speaker encoder is trained to be INVARIANT to accent, which is why the zero-shot baseline
# emits identical predictions for both targets.
#
...
echo "  commonaccent-mlp  0.383  0.489  0.452   0.072  0.888  0.915"
echo "  commonaccent-moe  0.365  0.509  0.490   0.078  0.903  0.923"
echo "  eres2netv2-mlp    0.430  0.455  0.428   0.052  0.916  0.919"
echo "  eres2netv2-moe    0.377  0.528  0.479   0.066  0.887  0.919"
echo ""
...
echo "  acc_sim  best so far (base/ecapa) uMSE 0.372  uLCC 0.515  uSRCC 0.468  sMSE 0.039  sLCC 0.933  sSRCC 0.970"
echo ""
