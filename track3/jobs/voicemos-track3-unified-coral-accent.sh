#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-unified-coral-accent
...
# CORAL + two-phase freeze, across encoder x head, for ACCENT similarity (acc_sim).
#
#   sbatch track3/jobs/voicemos-track3-unified-coral-accent.sh
#
...
#       track3/jobs/voicemos-track3-unified-coral-accent.sh
#   sbatch --export=ALL,ARMS=eres2netv2-mlp --time=12:00:00 \
#       track3/jobs/voicemos-track3-unified-coral-accent.sh
#   sbatch --export=ALL,ARMS=eres2netv2-moe --time=12:00:00 \
#       track3/jobs/voicemos-track3-unified-coral-accent.sh
#
# Best acc_sim so far on this dev set, for comparison (see ../../BRANCHES.md and the ecapa
# ladder): base/ecapa uMSE 0.372, uSRCC 0.468, sSRCC 0.970; corn/ecapa sLCC 0.945.
#
...
# emits identical predictions for both targets, and dev.yj-v2 reached its best accent
# number (UTT-SRCC 0.502) by switching to CommonAccent for acc_sim alone.
#
