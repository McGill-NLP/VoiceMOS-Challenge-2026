#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-ensemble-ecapa-accent
...
# Ensemble-candidate grid, ACCENT similarity, the ecapa-voxceleb encoder.
#
#   sbatch track3/jobs/ensemble/voicemos-track3-ensemble-ecapa-accent.sh
#
...
echo "  acc_sim  best single, 12-cell grid   uSRCC 0.552 (w24s4ep4 + coral + bilinear)"
