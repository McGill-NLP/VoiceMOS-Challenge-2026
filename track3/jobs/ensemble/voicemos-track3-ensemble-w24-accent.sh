#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-ensemble-w24-accent
...
# Ensemble-candidate grid, ACCENT similarity, the EXPENSIVE encoder.
#
#   sbatch track3/jobs/ensemble/voicemos-track3-ensemble-w24-accent.sh
#
