#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-ensemble-small-speaker
...
# Ensemble-candidate grid, SPEAKER similarity, the two CHEAP encoders.
#
#   sbatch track3/jobs/ensemble/voicemos-track3-ensemble-small-speaker.sh
#
