#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-unified-w24s4ep4-accent
...
# ERes2NetV2-w24s4ep4 against the plain ERes2NetV2 results, for ACCENT similarity.
#
#   sbatch track3/jobs/voicemos-track3-unified-w24s4ep4-accent.sh
#
...
#
#   sbatch --export=ALL,BATCH=2,ACCUM=8 track3/jobs/voicemos-track3-unified-w24s4ep4-accent.sh
#
...
echo "  coral    0.377  0.528  0.479   0.066  0.887  0.919   (selected on srcc_sys)"
echo "  mse      0.360  0.529  0.487   0.040  0.907  0.885"
echo "The CORAL row is not selection-matched; its srcc_utt-optimal dev-log point was"
echo "0.491 at step 18000, whose checkpoint was not saved."
echo ""
