#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-rank-n-contrast-speaker
...
# Rank-N-Contrast for Track 3 SPEAKER similarity (spk_sim).
#
...
# upload to CodaBench.
#
#   sbatch track3/jobs/voicemos-track3-rank-n-contrast-speaker.sh
#
