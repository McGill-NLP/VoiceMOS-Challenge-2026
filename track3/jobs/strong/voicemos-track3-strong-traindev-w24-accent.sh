#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-strong-traindev-w24-accent
...
# The strong-learner grid refit on TRAIN + DEV, ACCENT similarity, the eres2netv2-w24s4ep4 encoder, the slowest of the four.
#
#   sbatch track3/jobs/strong/voicemos-track3-strong-traindev-w24-accent.sh
#
...
#
# 4 x 2 x 2 = 16 cells per target. This file runs 4 of them for acc_sim;
# voicemos-track3-strong-traindev-small-accent.sh runs the other 12.
#
...
#       track3/jobs/strong/voicemos-track3-strong-traindev-w24-accent.sh
#
