#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-strong-traindev-small-speaker
...
# The strong-learner grid refit on TRAIN + DEV, SPEAKER similarity, the three cheaper encoders.
#
#   sbatch track3/jobs/strong/voicemos-track3-strong-traindev-small-speaker.sh
#
...
#
# 4 x 2 x 2 = 16 cells per target. This file runs 12 of them for spk_sim;
# voicemos-track3-strong-traindev-w24-speaker.sh runs the other 4.
#
...
#       track3/jobs/strong/voicemos-track3-strong-traindev-small-speaker.sh
#
