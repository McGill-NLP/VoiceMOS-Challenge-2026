...
# SSL encoder in the DEEP pipeline, SPEAKER similarity, WavLM Large read at layer 8.
#
...
#
#   encoder      wavlm-large-l8   (fixed in this job)
#   objective    mse | coral
...
#   training               4 arms x ~4.0h = ~15.8h
#   inference              4 arms x 4 passes x ~2 min = ~35 min
#   total                  ~16.4h, hence 19 h with slack.
#
