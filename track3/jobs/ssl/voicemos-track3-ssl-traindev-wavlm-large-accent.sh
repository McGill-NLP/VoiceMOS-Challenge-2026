#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-ssl-traindev-wavlm-large-accent
...
# SSL encoder in the DEEP pipeline, ACCENT similarity, WavLM Large read at layer 4.
#
#   sbatch track3/jobs/ssl/voicemos-track3-ssl-traindev-wavlm-large-accent.sh
#
...
#       track3/jobs/ssl/voicemos-track3-ssl-traindev-wavlm-large-accent.sh
#
