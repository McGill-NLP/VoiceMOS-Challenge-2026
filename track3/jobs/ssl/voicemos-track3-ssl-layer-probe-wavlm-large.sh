#!/usr/bin/env bash
#SBATCH --job-name=voicemos-track3-ssl-layer-probe-wavlm-large
...
# LAYER PROBE for WavLM Large: which transformer layer should the full SSL grid read?
#
#   sbatch track3/jobs/ssl/voicemos-track3-ssl-layer-probe-wavlm-large.sh
#
...
# l4 0.602, l8 0.545, l24 0.427 on spk_sim -- l4 is the best single model in
# the project; l4 0.541, l8 0.521, l24 0.495 on acc_sim.
#
...
#
#   wavlm-large-l4      63.5M params    52.6 GFLOP/utt  batch 16 x 1  ~2.2 h  (measured)
#   wavlm-large-l8     113.9M params    77.5 GFLOP/utt  batch 8 x 2  ~3.3 h  (extrapolated)
#   wavlm-large-l24    315.5M params   177.1 GFLOP/utt  batch 4 x 4  ~7.6 h  (extrapolated)
#
...
#
#   wavlm-large-l4   ~2.2 h  (measured, batch 16 x 1)
#   wavlm-large-l8   ~3.3 h  (extrapolated, batch 8 x 2)
#   wavlm-large-l24  ~7.6 h  (extrapolated, batch 4 x 4)
#   inference           3 arms x 4 passes x ~2 min = ~25 min
#   total               ~13.6 h, hence 16 h with slack.
#
...
#   sbatch --export=ALL,ARMS="wavlm-large-l24:mse:baseline" --time=10:00:00 \
#       track3/jobs/ssl/voicemos-track3-ssl-layer-probe-wavlm-large.sh
#
...
ALL_ARMS="wavlm-large-l4:mse:baseline wavlm-large-l8:mse:baseline wavlm-large-l24:mse:baseline"
ARMS=${ARMS:-"$ALL_ARMS"}
...
echo "=================================================================="
echo "LAYER PROBE, WavLM Large, fitted on TRAIN + DEV   metric=$METRIC"
echo "arms: $ARMS"
...
echo ""
echo "=================================================================="
echo "LAYER PROBE RESULT, WavLM Large"
echo ""
...
echo "  spk_sim  l4 0.602  l8 0.545  l24 0.427     acc_sim  l4 0.541  l8 0.521  l24 0.495"
echo ""
...
echo "     track3/jobs/ssl/voicemos-track3-ssl-traindev-wavlm-large-speaker.sh"
